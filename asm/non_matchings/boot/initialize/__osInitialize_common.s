...
/* 02C1C 8000307C 3C018001 */  lui     $at, %hi(__osFinalrom)               ## $at = 80010000
...
/* 02C2C 8000308C AC2E8960 */  sw      $t6, %lo(__osFinalrom)($at)          ## 80008960
...
.L8000311C:
/* 02CBC 8000311C 3C088000 */  lui     $t0, %hi(__osExceptionPreamble)                ## $t0 = 80000000
/* 02CC0 80003120 25082430 */  addiu   $t0, $t0, %lo(__osExceptionPreamble)         ## $t0 = 80002430
/* 02CC4 80003124 8D010000 */  lw      $at, 0x0000($t0)           ## 80002430
/* 02CC8 80003128 3C198000 */  lui     $t9, 0x8000                ## $t9 = 80000000
/* 02CCC 8000312C 3C0D8000 */  lui     $t5, %hi(__osExceptionPreamble)                ## $t5 = 80000000
/* 02CD0 80003130 AF210000 */  sw      $at, 0x0000($t9)           ## 80000000
/* 02CD4 80003134 8D0B0004 */  lw      $t3, 0x0004($t0)           ## 80002434
/* 02CD8 80003138 25AD2430 */  addiu   $t5, $t5, %lo(__osExceptionPreamble)          ## $t5 = 80002430
...
/* 02DE0 80003240 3C088000 */  lui     $t0, %hi(osResetType)                ## $t0 = 80000000
/* 02DE4 80003244 8D08030C */  lw      $t0, %lo(osResetType)($t0)           ## 8000030C
/* 02DE8 80003248 3C018000 */  lui     $at, %hi(osClockRate)               ## $at = 80000000
/* 02DEC 8000324C AC226350 */  sw      $v0, %lo(osClockRate)($at)           ## 80006350
/* 02DF0 80003250 15000005 */  bne     $t0, $zero, .L80003268
/* 02DF4 80003254 AC236354 */  sw      $v1, 0x6354($at)           ## 80006354
/* 02DF8 80003258 3C048000 */  lui     $a0, %hi(osAppNMIBuffer)                ## $a0 = 80000000
/* 02DFC 8000325C 2484031C */  addiu   $a0, $a0, %lo(osAppNMIBuffer)          ## $a0 = 8000031C
/* 02E00 80003260 0C000BA0 */  jal     bzero              ## bzero
/* 02E04 80003264 24050040 */  addiu   $a1, $zero, 0x0040         ## $a1 = 00000040
.L80003268:
/* 02E08 80003268 3C198000 */  lui     $t9, %hi(osTvType)                ## $t9 = 80000000
/* 02E0C 8000326C 8F390300 */  lw      $t9, %lo(osTvType)($t9)           ## 80000300
...
/* 02E20 80003280 3C018000 */  lui     $at, %hi(osViClock)                ## $at = 80000000
/* 02E24 80003284 1000000F */  beq     $zero, $zero, .L800032C4
/* 02E28 80003288 AC2A6358 */  sw      $t2, %lo(osViClock)($at)           ## 80006358
.L8000328C:
/* 02E2C 8000328C 3C098000 */  lui     $t1, %hi(osTvType)                ## $t1 = 80000000
/* 02E30 80003290 8D290300 */  lw      $t1, %lo(osTvType)($t1)           ## 80000300
...
/* 02E48 800032A8 3C018000 */  lui     $at, %hi(osViClock)                ## $at = 80000000
/* 02E4C 800032AC 10000005 */  beq     $zero, $zero, .L800032C4
/* 02E50 800032B0 AC2B6358 */  sw      $t3, %lo(osViClock)($at)           ## 80006358
.L800032B4:
/* 02E54 800032B4 3C0D02E6 */  lui     $t5, 0x02E6                ## $t5 = 02E60000
/* 02E58 800032B8 35ADD354 */  ori     $t5, $t5, 0xD354           ## $t5 = 02E6D354
/* 02E5C 800032BC 3C018000 */  lui     $at, %hi(osViClock)                ## $at = 80000000
/* 02E60 800032C0 AC2D6358 */  sw      $t5, %lo(osViClock)($at)           ## 80006358
.L800032C4:
