...
build/lib/libultra/src/io/epirawwrite.o: OPTIMIZATION := -O2
build/lib/libultra/src/io/epirawread.o: OPTIMIZATION := -O2
build/lib/libultra/src/io/epiread.o: OPTIMIZATION := -O2
build/lib/libultra/src/io/epiwrite.o: OPTIMIZATION := -O2
