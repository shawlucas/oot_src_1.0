...
beginseg
     ...
     include "build/asm/libultra_boot/osCreateMesgQueue.o"
     include "build/asm/osInvalDCache.o"
     include "build/asm/libultra_boot/__osSiDeviceBusy.o"
     include "build/lib/libultra/src/os/jammesg.o"
     include "build/asm/libultra_boot/osSetThreadPri.o"
     include "build/asm/libultra_boot/osGetThreadPri.o"
     include "build/asm/libultra_boot/osEPiRawReadIo.o"
     include "build/asm/libultra_boot/osEPiRawStartDma.o"
     include "build/asm/libultra_boot/osGetTime.o"
