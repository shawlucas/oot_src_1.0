...
beginseg
     ...
     include "build/lib/libc/src/ll.o"
     include "build/lib/libultra/src/os/exceptasm.o"
     include "build/asm/libultra_boot/__osDequeueThread.o"
     include "build/asm/libultra_boot/osDestroyThread.o"
     include "build/asm/bzero.o"
     include "build/asm/libultra_boot/osCreateThread.o"
     include "build/asm/libultra_boot/initialize.o"
     include "build/asm/__osSetSR.o"
     include "build/asm/__osGetSR.o"
     include "build/asm/osWritebackDCache.o"
     include "build/asm/libultra_boot/osViGetNextFramebuffer.o"
     include "build/asm/libultra_boot/pimgr.o"
     include "build/asm/libultra_boot/__osDevMgrMain.o"
     include "build/asm/libultra_boot/__osPiRawStartDma.o"
     ...
     include "build/asm/libultra_boot/__osEPiRawReadIo.o"
     include "build/asm/libultra_boot/__osEPiRawStartDma.o"
