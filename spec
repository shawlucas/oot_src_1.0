...
beginseg
     ...
     include "build/asm/libultra_boot/osGetThreadId.o"
     include "build/lib/libultra/src/os/setintmask.o"
     //include "data/setintmask.data.o"
     include "build/asm/libultra_boot/osViSetMode.o"
     include "build/asm/__osProbeTLB.o"
     include "build/asm/libultra_boot/osGetMemSize.o"
     include "build/asm/libultra_boot/osSetEventMesg.o"
