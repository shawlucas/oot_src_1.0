...
beginseg
     ...
     include "build/lib/libultra/src/io/driverominit.o"
     include "build/asm/boot/yaz0_old.o"
     include "build/src/boot/stackcheck.o"
     include "build/src/boot/logutils.o"
     include "build/lib/libultra/src/io/piacs.o"
     include "build/lib/libultra/src/os/sendmesg.o"
     include "build/lib/libultra/src/os/stopthread.o"
     include "build/lib/libultra/src/os/recvmesg.o"
     include "build/lib/libultra/libc/src/ll.o"
     include "build/lib/libultra/src/os/exceptasm.o"
     include "build/lib/libultra/src/os/__osDequeueThread.o"
     include "build/lib/libultra/src/os/destroythread.o"
     include "build/lib/libultra/libc/src/bzero.o"
     include "build/lib/libultra/src/os/createthread.o"
     include "build/lib/libultra/src/os/initialize.o"
     include "build/lib/libultra/src/os/setsr.o"
     include "build/lib/libultra/src/os/getsr.o"
     include "build/lib/libultra/src/os/writebackdcache.o"
     include "build/lib/libultra/src/io/vigetnextframebuf.o"
     ...
     include "build/lib/libultra/src/os/virtualtophysical.o"
     include "build/lib/libultra/src/io/viblack.o"
     include "build/lib/libultra/src/io/sirawread.o"
     include "build/lib/libultra/src/os/getthreadid.o"
     include "build/lib/libultra/src/os/setintmask.o"
     include "build/lib/libultra/src/io/visetmode.o"
     include "build/lib/libultra/src/os/probetlb.o"
     include "build/lib/libultra/src/os/getmemsize.o"
     include "build/lib/libultra/src/os/seteventmesg.o"
     include "build/lib/libultra/src/os/unmaptlball.o"
     include "build/lib/libultra/src/io/epidma.o"
     include "build/lib/libultra/src/os/invalicache.o"
     include "build/lib/libultra/src/os/createmesgqueue.o"
     include "build/lib/libultra/src/os/invaldcache.o"
     include "build/lib/libultra/src/io/si.o"
     include "build/lib/libultra/src/os/jammesg.o"
     include "build/lib/libultra/src/os/setthreadpri.o"
     include "build/lib/libultra/src/os/getthreadpri.o"
     ...
     include "build/lib/libultra/src/os/getcount.o"
     include "build/lib/libultra/src/os/setglobalintmask.o"
     include "build/lib/libultra/src/os/setcompare.o"
     include "build/lib/libultra/libc/src/bcopy.o"
     ...
     include "build/lib/libultra/src/io/pigetcmdq.o"
     include "build/lib/libultra/src/io/epiread.o"
     include "build/lib/libultra/src/io/cartrominit.o"
     include "build/lib/libultra/src/os/setfpccsr.o"
     include "build/lib/libultra/src/os/getfpccsr.o"
     include "build/lib/libultra/src/io/epiwrite.o"
     include "build/lib/libultra/src/os/maptlbrdb.o"
     include "build/lib/libultra/src/os/yieldthread.o"
     include "build/lib/libultra/src/os/getcause.o"
     include "build/lib/libultra/src/io/epirawwrite.o"
     include "build/lib/libultra/src/os/settimer.o"
     include "build/lib/libultra/src/io/sirawwrite.o"
     include "build/lib/libultra/src/io/vimgr.o"
     include "build/lib/libultra/src/io/vigetcurrcontext.o"
     include "build/lib/libultra/src/os/startthread.o"
     include "build/lib/libultra/src/os/sethwinterrupt.o"
     include "build/lib/libultra/src/os/gethwinterrupt.o"
     include "build/data/boot.data.o"
     include "build/data/setintmask.data.o"
...
endseg
beginseg
     name "jpn_font_static"
  //   romalign 0x1000
     include "build/baserom/jpn_font_static.o"
endseg
beginseg
     name "link_animetion"
     romalign 0x1000
...
beginseg
     ...
     romalign 0x1000
     include "build/baserom/jpn_message_data_static.o"
endseg
beginseg
...
beginseg
     ...
     include "build/asm/code/z_actor.o"
     include "build/asm/code/z_bgcheck.o"
     include "build/asm/code/z_camera.o"
     include "build/asm/code/z_collision_btltbls.o"
     include "build/asm/code/z_collision_check.o"
     include "build/asm/code/z_common_data.o"
     include "build/asm/code/z_debug.o"
     include "build/asm/code/z_debug_display.o"
     include "build/asm/code/z_demo.o"
     include "build/asm/code/mem.o"
     include "build/asm/code/z_draw.o"
     include "build/asm/code/code_80058F20.o"
     include "build/asm/code/z_elf_message.o"
     include "build/asm/code/z_face_reaction.o"
     include "build/asm/code/z_env_flag.o"
     include "build/asm/code/z_fcurve_data_skelanime.o"
     include "build/asm/code/z_horse.o"
     include "build/asm/code/z_jpeg.o"
     include "build/asm/code/code_8005B860.o"
     include "build/asm/code/z_kanfont.o"
     include "build/asm/code/z_kankyo.o"
     include "build/asm/code/z_lib.o"
     include "build/asm/code/z_lifemeter.o"
     include "build/asm/code/z_lights.o"
     include "build/asm/code/z_malloc.o"
     include "build/asm/code/z_map_mark.o"
     include "build/asm/code/z_prenmi_buff.o"
     include "build/asm/code/z_msgevent.o"
     include "build/asm/code/vector.o"
     include "build/asm/code/z_onepointdemo.o"
     include "build/asm/code/z_map_exp.o"
     include "build/asm/code/z_parameter.o"
     include "build/asm/code/z_player_lib.o"
     include "build/asm/code/z_prenmi.o"
     include "build/asm/code/z_quake.o"
     include "build/asm/code/z_rcp.o"
     include "build/asm/code/z_room.o"
     include "build/asm/code/z_sample.o"
     include "build/asm/code/z_scene.o"
     include "build/asm/code/z_skelanime.o"
     include "build/asm/code/z_skin.o"
     include "build/asm/code/z_skin_awb.o"
     include "build/asm/code/z_skin_matrix.o"
     include "build/asm/code/z_sram.o"
     include "build/asm/code/z_view.o"
     include "build/asm/code/z_vimode.o"
     include "build/asm/code/z_vr_box.o"
     include "build/asm/code/z_vr_box_draw.o"
