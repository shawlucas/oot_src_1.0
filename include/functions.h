...
void KaleidoManager_Init(GlobalContext* ctx);
void KaleidoManager_Destroy();
void* KaleidoManager_GetRamAddr(void* vram);
void KaleidoScopeCall_LoadPlayer();
void KaleidoScopeCall_Init(GlobalContext* ctx);
void KaleidoScopeCall_Destroy(GlobalContext* ctx);
void KaleidoScopeCall_Update(GlobalContext* ctx);
void KaleidoScopeCall_Draw(GlobalContext *ctx);
// ? func_800BC450(?);
// ? func_800BC490(?);
